...
const loginSchema = z.object({
  ...
  function FgForm() {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        //
        const response = await axios.post('https://localhost:9000/auth/reset-password', { newPassword:password, token: Code });
  ...
  e.preventDefault();
    if(!email){
     ...
     try{
       ...
       const response = await axios.post('http://localhost:9000/auth/forgot-password',{Email: email});
